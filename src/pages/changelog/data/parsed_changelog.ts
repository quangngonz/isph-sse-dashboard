import ParsedChangelog from "../../../utils/types/changelog";

export const parsedChangelog: ParsedChangelog = [
    {
        "phase_name": "Early Stages & Foundation",
        "phase_items": [
            {
                "date": "2024-12-03",
                "user": "USER FRONTEND",
    ...
    {
        "phase_name": "Core Feature Development",
        "phase_items": [
            {
                "date": "2024-12-14",
                "user": "USER FRONTEND",
    ...
    {
        "phase_name": "Real-time, UI/UX, and Feature Enhancements",
        "phase_items": [
            {
                "date": "2025-01-30",
                "user": "CLIENT API",
    ...
    {
        "phase_name": "Admin Dashboard and User Management",
        "phase_items": [
            {
                "date": "2025-02-03",
                "user": "CLIENT API",
